  ...
  return (
    <section className="bg-gradient-to-r from-blue-200 via-purple-200 to-indigo-200 dark:from-gray-800 dark:via-gray-900 dark:to-gray-950">
      <div className="container mx-auto py-20 flex flex-col items-center justify-center px-6 space-y-16 md:space-y-16">
        <h1 className="text-4xl sm:text-5xl lg:text-5xl font-extrabold text-black dark:text-white text-center leading-tight">
          Next.js, Tailwind, TypeScript & ShadCN Template
        </h1>
        <p className="text-base sm:text-lg lg:text-xl text-black dark:text-gray-300 text-center max-w-3xl leading-relaxed">
